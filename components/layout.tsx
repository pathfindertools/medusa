      ...
      <ThemeContext.Provider value={globalData}>
        ...
        <div className={`min-h-screen flex flex-col`}>
          ...
          <div className="px-10 pb-10 pt-20">
            <ul className="justify-center flex gap-6 mx-auto text-md pb-4">
            ...
            <p className="mx-auto text-center text-md">Made with love by <a className="underline" href="https://protocol.ai/" target="_blank">Protocol Labs</a></p>
          </div>
        </div>
